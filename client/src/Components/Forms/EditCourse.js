...
//         //  const allModulesInCourse = [...moduleIdsInCourse, ...modulesWithTeacherDetails];
...
//         const courseResponse = await axios.get(`http://localhost:3001/course/${course.courseId}`);
//         const courseData = courseResponse.data;
//         const moduleIdsInCourse = courseData.modules.map((module) => module.moduleId);
//         console.log("Module IDs in Course:", moduleIdsInCourse);
  
//         const modulesResponse = await axios.get("http://localhost:3001/module");
//         const allModuleIds = modulesResponse.data.map((module) => module.moduleId);
...
//         console.log(modulesWithTeacher, "fdfdf");
...
//           durationType: course.durationType,
//           courseFee: course.courseFee,
//           modules: allModulesInCourse, // Updated modules list
//         }));
//       } catch (error) {
//         console.error("Error fetching modules:", error);
//       }
...
//     try {
//       // Send the selected modules to the server and update the course data
//       const updatedModules = availableModules.filter((module) =>
...
//                     primary={`${module.moduleId}`}
//                     secondary={
//                       module.teacher ? `Teacher: ${module.teacher}` : null
//                     }
//                   />
//                   <ListItemIcon>
//                     <RemoveCircleIcon
...
//       setFormValues((prevFormValues) => ({
//         ...prevFormValues,
//         modules: [...prevFormValues.modules, ...updatedModules],
//       }));
//       handleCloseAddModulesDialog();
//     } catch (error) {
//       console.error("Error adding modules:", error);
