...
import CoursePayment from '../PlacementTest/CoursePayment';
import '../PlacementTest/CourseDetails.scss'

const CourseDetails = ({ studentId,studentMarks }) => {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:3001/student')
        ...
        .then(data => {
            const loggedInStudent = data.find(student => student.stuId === studentId);
                if (loggedInStudent) {
